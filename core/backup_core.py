...
class Backup():
    def __init__(self):
        ...
        cache = cur.fetchone()
        cache2 = {'ver':1.2,'data':[*cache[1:6],'a0.2-22w23b',cache[7:]]}
        # JSON
                ...
                if ver == 1.2:
                    ...
                    if len(data) == 11:
                        ...
                        try:
                            ...
                            cache = "INSERT INTO data values (1,'{}',{},'{}',{},{},'a0.2-22w23b',{},{},'{}','{}',{})".format(*data)
                            cur.execute(cache)
                            con.commit()
                        except Exception as e:
                            con.rollback()
                    ...
                    if len(data) == 7:
                        try:
                            cur.execute("DELETE FROM data WHERE id=1")
                            sql_cache = "INSERT INTO data values (1,'{}',{},'{}',{},{},'a0.2-22w23b',{},{},'{}','{}')".format(*data,cache[8:])
                    ...
                    if len(data) == 5:
                        try:
                            cur.execute("DELETE FROM data WHERE id=1")
                            cache = ''
                            sql_cache = "INSERT INTO data values (1,'{}',{},'{}',{},{},'a0.2-22w23b',{})".format(*data,cache[7:])
                            cur.execute(sql_cache)
                            con.commit()
                        except Exception as e:
                            con.rollback()
